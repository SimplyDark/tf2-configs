...
Scheme
{
	...
	Colors
	{
		...
		"G_Dying"				"212 0 0 230"
		"G_Heal"				"0 255 255 255" // Heal color
		...
		"G_Overheal"			"0 255 255 255" // Overhealed health value color
		"G_LowHealthValue"		"255 0 0 255" // Low health value color
		"G_AmmoClipValue"		"0 128 192 255" // Ammo in clip value color
		"G_AmmoReserveValue"	"0 0 255 255" // Ammo in reserve value color
		...
		"G_CrosshairColor"				"255 255 255 140" // Crosshair color
		"G_CrosshairShadowColor"		"0 0 0 255"	// Crosshair shadow color
		"G_CrosshairColorLowHealth"		"255 255 255 140" // Crosshair color when low health
	...
	Fonts
	{
		...
		"G_FontDamage"
		{
			"1"
			{
				"name"			"ToonHUD Montserrat" [$WINDOWS] // Damage font
				"name"			"TF2 Build" [!$WINDOWS]
				"tall"			"20" // Damage size
				"weight"		"0"
				"additive"		"0"
		...
		"G_FontCritDamage"
		{
			"1"
			{
				"name"			"ToonHUD Montserrat" [$WINDOWS] // Crit damage font
				"name"			"TF2 Build" [!$WINDOWS]
		...
		"CloseCaption_Normal"
		{
			"1"
			{
				"name"		"Montserrat" [$WINDOWS] // Closed captions font
				"name"		"TF2 Secondary" [!$WINDOWS]
	...
	CustomFontFiles
	{
		...
		"21" "resource/fonts/crosshairs.ttf"
	}
}
